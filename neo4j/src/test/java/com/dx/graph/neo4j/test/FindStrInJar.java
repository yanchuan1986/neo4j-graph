...
//                            }
    ...
    public static void main(String args[]) {
        FindStrInJar findInJar = new FindStrInJar("Content-Security-Policy"); //要寻找的字符串
        List<String> jarFiles = findInJar.find("/Users/yanchuan/Downloads/neo4j-community-3.3.6/lib", true);
        if (jarFiles.size() == 0) {
